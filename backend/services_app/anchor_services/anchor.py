...
class AnchorQueries:
    ...
    def get_all_anchor_location(self):
        """
                Fetch anchor data from the external API using the API_PREFIX_VIZ from environment.
                Returns the response data if successful, otherwise raises an exception.
                """
        endpoint = "/api/common/anchor-locations/"
        return self.make_request('GET', endpoint)

    def get_online_anchors(self):
        """
        Fetch anchor data from the external API using the API_PREFIX_VIZ from environment.
        Returns the response data if successful, otherwise raises an exception.
        """
        endpoint = "/api/anchor/user-anchor/"
        return self.make_request('GET', endpoint)

    def get_user_anchor_registered(self):
         """
            Fetch anchor data from the external API using the API_PREFIX_VIZ from environment.
            Returns the response data if successful, otherwise raises an exception.
            """
         endpoint = "/api/anchor/anchor-register/"
         return self.make_request('GET', endpoint)

    def get_anchors_services_result(self):
        """
        Fetch anchor data from the external API using the API_PREFIX_VIZ from environment.
        Returns the response data if successful, otherwise raises an exception.
        """
        endpoint = "/api/anchor/command-history/"
        return self.make_request('GET', endpoint)
