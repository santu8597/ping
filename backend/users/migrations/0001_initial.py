    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('points', models.IntegerField(default=20000)),
                ...
                ('institution_name', models.CharField(blank=True, default='', max_length=100, null=True)),
                ...
                ('user_pk', models.CharField(blank=True, default='', max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('faculty', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='students', to=settings.AUTH_USER_MODEL)),
